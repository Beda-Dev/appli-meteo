...
export default function Prevision({ ville }: Props) {
    ...
    if (loading) {
        return <div className="rounded-xl text-white p-2 max-h-[275px] min-h-[324px] max-w-72 h-90 bg-white bg-opacity-20">
            <span className="loading loading-spinner loading-lg"></span></div>;
    }

    if (error) {
        return <div className="rounded-xl text-white p-2 max-h-[275px] min-h-[324px] max-w-72 h-90 bg-white bg-opacity-20">{error}</div>;
    }

    return (
        <div className="rounded-xl text-white p-2 max-h-[275px] min-h-[324px] max-w-72 h-90 bg-white bg-opacity-20">
            {resultat ? (
                <div className="">
