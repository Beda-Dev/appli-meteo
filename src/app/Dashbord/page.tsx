    ...
    return (<div className="bg-transparent rounded-lg grid grid-cols-[64px_300px_1fr_390px] grid-row-[256px_256px_256px]">
                ...
                <div className="border text-center bg-transparent backdrop-blur-lg  text-white w-16 h-screen rounded-lg p-1 row-start-1 col-start-1 row-span-3 mb-4">
                    <ul className=" space-y-2">
                        ...
                        <li className=" flex  p-4 justify-center items-center rounded-lg hover:bg-blue-900"><Image src="/carte.png" alt="Logo" width={70} height={70} className="pb-2 rounded-mg hover:bg-blue-900 mx-auto  duration-200 transform  hover:scale-y-150"  /></li>
                        <li className=" flex  p-4 justify-center items-center rounded-lg hover:bg-blue-900"><Image src="/tools.png" alt="Logo" width={70} height={70} className="pb-2 rounded-mg hover:bg-blue-900 mx-auto  duration-200 transform  hover:scale-y-150" /></li>
                    </ul>
                ...
                <div className="bg-transparent backdrop-blur-md h-20 w-full py-4 px-1 row-start-1 col-start-2 col-span-3 flex relative ml-2">
                        <div className="relative flex ">
                            <input
                                ...
                                className="w-full h-12 bg-blue-900 backdrop-blur-lg rounded-lg text-center text-white pr-12 pl-12 bg-opacity-3 shadow-sm"
                            />
